...
def load_documents_from_csv(file_path: Union[str, Path], 
...
def load_documents_from_text_file(file_path: Union[str, Path], 
    ...
    try:
        ...
        return [{"id": str(i), "text": chunk, "source": str(file_path)} 
...
def create_document_metadata(document: str, source: str, 
